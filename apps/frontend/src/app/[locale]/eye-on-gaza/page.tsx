...
export default function Page() {
  ...
  return (
    <div className="mx-auto mt-16 flex max-w-screen-lg flex-col gap-16">
      <div className="relative flex h-fit w-full rounded-2xl bg-gray-50/80 p-8 px-8 bg-dot-black/[0.35] dark:bg-black dark:bg-dot-white/[0.2]">
        <h1 className="text-9xl font-medium text-gray-800">{t.eyeOnGaza()}</h1>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              {/* <p className="text-gray-600">
                This upcoming feature will serve as a dedicated news and
                documentation hub that will:
              </p> */}
