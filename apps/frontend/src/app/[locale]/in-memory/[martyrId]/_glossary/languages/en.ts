...
export const translations_EN = createTranslation<Definition>({
  ...
  shareDialogTitle: "Spread the story",
  shareDialogDescription: "Let the world know about this story",
  shareText: "Learn about {{name}}",
  shareTitle: "Remember {{name}}",
  shareOrDirectly: "Or directly share on",
  shareVia: "Share via...",
  socialPlatform: "{{platform}}",
  copyLink: "Copy link",
  copied: "Copied",
  copySuccess: "Text copied to clipboard",
  copyLinkPlaceholder: "https://www.gazainmemory.tech/en/in-memory/123",
  facebook: "Facebook",
  instagram: "Instagram",
  linkedin: "LinkedIn",
  twitter: "Twitter",
  whatsapp: "WhatsApp",
  telegram: "Telegram",
  signInToShareMemory: "Sign in to share memory",
});
